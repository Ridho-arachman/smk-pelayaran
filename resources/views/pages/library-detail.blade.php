...
<div class="container mx-auto px-4 py-8">
    <div class="flex flex-col md:flex-row gap-8">
        ...
        <div class="w-full md:w-1/3">
            <img src="{{ Storage::url($library->cover_image) }}" 
                alt="{{ $library->title }}" 
        ...
        <div class="w-full md:w-2/3">
            ...
            <div class="space-y-4">
                ...
                <div class="badge badge-primary">{{ Library::getCategories()[$library->category] ?? $book->category }}</div>
                            ...
                            @else
                                ...
                                <div class="flex items-center gap-2">
                                    ...
                                    @if($library->stock > 0)
                                        ...
                                        <p class="text-sm text-base-content/60 mt-1">* Kunjungi perpustakaan untuk peminjaman buku fisik</p>
                                    @else
                ...
                @if($library->file_path && $library->is_available)
                    @if($library->type === 'digital')
                        <div class="mt-8">
                            @if($library->is_available)
                                <a href="{{ Storage::url($library->file_path) }}" 
                                    target="_blank"
