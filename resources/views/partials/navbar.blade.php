<div class="navbar bg-base-100 shadow-lg fixed z-50 top-0 right-0 left-0">
    ...
    <div class="navbar-end flex gap-6 justify-end items-center">
        <label class="swap swap-rotate btn btn-md rounded">
            <!-- this hidden checkbox controls the state -->
            <input type="checkbox" class="theme-controller" value="dracula" id="theme-toggle" />
        ...
        <a href="/auth" class="btn btn-primary rounded hidden md:flex">Daftar</a>
    </div>
</div>
